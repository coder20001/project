...
<div class="container">
    <div class="form">
        ...
        <button class="sign">
            <a href="maintenanceview.php">Continue</a>
        </button>
    </div>
...
//storing the value from my form
...
if ($result === false){
    die("there was a problem with your sql statement.");
}
while($row = $result->fetch_assoc()){
    $username = $row['UserFName']; 
    $rol = $row['Role'];
echo "<a href=\"maintenanceview.php?id={$row['UserID']}\"><input type=\"button\" value=\"continue\"></a>";
}
