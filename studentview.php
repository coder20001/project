...
if (isset($_SESSION['username'])) {
    ...
    $user_id_query = "SELECT UserID FROM user WHERE UserEmail = ?";
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                echo "<tr>
                        ...
                        <td><button class=\"view-details-btn\" onclick=\"location.href='viewticketstudent.php?id=" . urlencode($row['TicketID']) . "';\">View Details</button></td>
                        </tr>";
            }
        } else {
