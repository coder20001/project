...
<body>
    ...
    <header>
        ...
        <h1>Maintenance Staff Update</h1>
...
if ($result->num_rows > 0) {
    ...
    echo "<td style='text-align: center;'><button class=\"no-button\" onclick=\"location.href='req.html?id=" . urlencode($row['TicketID']) . "';\">Update Ticket</button></td>";
