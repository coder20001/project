...
<body>
    <div class="container">
        <div class="form">    
            ...
            <h1>Register</h1>
            <form action="secretarycheck.php" method="post">
    ...
    <option value="Maintenance Staff">Maintenance Staff</option>
                ...
                <div class="floating-label">
                <input type="text" placeholder=" " pattern="S\d{2}[A-Za-z]\d{4}" name="secnumber" required>
            ...
            <div class="floating-label">
                ...
                <div class="floating-label"> <input type="hidden" name="UserID" id="UserID" value = "hall secretary"> </div>
                <div class="floating-label"> <input type="hidden" name="UserID" id="UserID" value = "
                <?php
                echo $userid
                ?>
                "> </div>
