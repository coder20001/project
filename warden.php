...
<body>
    <div class="container">
        <div class="form">
         ...
         <h1>Register</h1>     
         <form action="wardencheck.php" method="post">
    ...
    <option value="Maintenance Staff">Maintenance Staff</option>
            ...
            <div class="moveup">
                ...
                <div class="floating-label">
                    <input type="text" placeholder=" " pattern="W\d{2}[A-Za-z]\d{4}" name="wardnumber" required>
          ...
          <div><input type="submit" class="sign" id="sign" name="sign" value="Sign up"></div> 
