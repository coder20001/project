...
$sql= "SELECT
	maintenanceticket.staffNumber
FROM 
	maintenanceticket 
JOIN 
	maintenancestaff  ON maintenanceticket.staffNumber=MaintenanceStaff.staffNumber
JOIN 
	user ON user.UserID = maintenancestaff.UserID";
